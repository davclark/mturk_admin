...
# In spite of claims to the contrary, MTurk signing still appears not working in
# boto
...
# import base64
#
# def fixed_calc_signature(self, params, *args):
...
#
# boto.auth.QuerySignatureV1AuthHandler._calc_signature = fixed_calc_signature
...
class MyTurkers:
    ...
    def create_qual(self, qual_name, qual_description, active=True):
        ...
        qual = self.conn.create_qualification_type(
                        qual_name, qual_description, active_txt)
